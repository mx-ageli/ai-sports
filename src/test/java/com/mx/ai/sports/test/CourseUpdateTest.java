...
public class CourseUpdateTest {
    ...
    private Map<String, CourseUpdateVo> initCourseData() {
        ...
        courseUpdateVo1.setMaxCount(500);
        courseUpdateVo1.setGroupCount(10);
        ...
        courseUpdateVo2.setMaxCount(500);
        courseUpdateVo2.setGroupCount(10);
        ...
        courseUpdateVo5.setMaxCount(500);
        courseUpdateVo5.setGroupCount(10);
        ...
        courseUpdateVo6.setMaxCount(500);
        courseUpdateVo6.setGroupCount(10);
        ...
        courseUpdateVo8.setMaxCount(500);
        courseUpdateVo8.setGroupCount(10);
        ...
        courseUpdateVo9.setMaxCount(500);
        courseUpdateVo9.setGroupCount(10);
        ...
        courseUpdateVo10.setMaxCount(500);
        courseUpdateVo10.setGroupCount(10);
